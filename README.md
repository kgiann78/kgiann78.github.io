...
The original posts that came with the theme are stored in the `test` directory in order to advise it for markdown format.



### Next, follows information about the Jekyll Theme (Beautiful Jekyll) that is used. 
